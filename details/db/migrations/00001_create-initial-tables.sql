...
CREATE TABLE maps
(
    map_id          int GENERATED BY DEFAULT AS IDENTITY (START WITH 1000),
...
(
    category_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1000),
    description varchar NOT NULL,
...
(
    subcategory_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1000),
...
(
    report_id        int GENERATED BY DEFAULT AS IDENTITY (START WITH 1000),
    user_id          int     NOT NULL,
    map_id           int     NOT NULL,
...
(
    marker_id      int GENERATED BY DEFAULT AS IDENTITY (START WITH 1000),
    map_id         int   NOT NULL,
    subcategory_id int   NOT NULL,
    location       point NOT NULL,
